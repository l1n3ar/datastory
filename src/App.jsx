...
const App = () => {
  ...
  return (
    <div className='snap-y snap-mandatory h-screen overflow-y-scroll'>
      ...
      <div className='Slide-1 w-screen h-screen snap-center flex flex-col gap-10 bg-[#262626] items-center justify-center'>
      ...
      <div ref={slide2Ref} className='Slide-2 w-screen h-screen snap-center flex flex-col gap-36 items-center justify-center bg-[#35e38f]'>
      ...
      <div ref={slide3Ref} className='Slide-3 w-screen h-screen snap-center flex flex-col gap-10 items-center justify-center bg-[#262626]'>
      ...
      <div className='Slide-4 w-screen h-screen snap-center flex flex-col items-center justify-center bg-[#262626]'>
      ...
      <div className='Slide-5 w-screen h-screen snap-center flex flex-col gap-5 items-center justify-center bg-[#262626]'>
      ...
      <div className='Slide-6 w-screen h-screen snap-center flex flex-col items-center justify-center bg-[#262626] text-white'>
      <div className='w-[60rem]'><img src='/slide-6.png' alt='slide-3' /></div>
      </div>

      <div className='Slide-7 w-screen h-screen snap-center flex items-center justify-center text-[#35e38f] font-["Roboto Condensed"] text-5xl bg-[#262626]'>
      ...
      <div className='Slide-8 w-screen h-screen snap-center flex flex-col gap-28 bg-[#262626] items-center justify-center text-white'>
      ...
      <div className='Slide-9 w-screen h-screen snap-center flex flex-col items-center justify-center bg-[#262626] gap-10 text-white font-["Roboto"]'>
      ...
      <div className='Slide-10 w-screen h-screen snap-center flex flex-col items-center justify-center bg-[#262626] gap-12 text-white font-["Roboto"]'>
      ...
      <div className='Slide-11 w-screen h-screen snap-center flex flex-col items-center justify-center bg-[#262626] gap-12 text-white font-["Roboto"]'>
      ...
      <div className='Slide-12 w-screen h-screen snap-center flex flex-col items-center justify-center bg-[#262626] gap-12 text-white font-["Roboto"]'>
      ...
      <div className='Slide-13 w-screen h-screen snap-center flex flex-col items-center justify-center bg-[#262626] gap-12 text-white font-["Roboto"]'>
      ...
      <div className='Slide-14 w-screen h-screen snap-center flex flex-col items-center justify-center  bg-[#35e38f] gap-12 text-[#262626] font-["Roboto"]'>
      ...
      <div className='Slide-15 w-screen h-screen snap-center flex flex-col items-center justify-center bg-[#262626] gap-12 text-white font-["Roboto"]'>
